...
<!-- Bootstrap Slider -->
<!--<script src="<?= base_url() ?>assets/admin/js/plugins/bootstrap-slider/bootstrap-slider.js" type="text/javascript"></script>-->
...
<!-- Datepicker -->
<!--<script src="<?= base_url() ?>assets/admin/js/plugins/datepicker/bootstrap-datepicker.js" type="text/javascript"></script>-->
