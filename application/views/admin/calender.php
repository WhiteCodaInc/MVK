...
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/admin/js/plugins/Qtip/css/jquery.qtip.css"/>
<style>
    .ui-autocomplete { 
        cursor:pointer; 
        height:120px; 
...
<!-- QTip -->
<script src="<?= base_url() ?>assets/admin/js/plugins/Qtip/js/jquery.qtip.js" type="text/javascript"></script>
